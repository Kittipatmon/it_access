...
<body class="bg-slate-50 flex items-center justify-center min-h-screen p-6">
    <div
        class="max-w-md w-full bg-white rounded-3xl shadow-xl shadow-slate-200/50 overflow-hidden border border-slate-100">
        <div class="p-8">
            ...
            <form action="{{ route('login') }}" method="POST" class="space-y-6">
                ...
                <div>
                    <button type="submit"
                        class="w-full bg-blue-600 hover:bg-blue-700 text-white font-bold py-3 px-4 rounded-xl shadow-lg shadow-blue-200 transition-all active:scale-95">
                        เข้าสู่ระบบ
                    </button>
                </div>
            </form>
            ...
            <div class="mt-8 text-center text-slate-400 text-xs">
                © 2026 IT Kumwell Corporation Public Company Limited.
            </div>
        </div>
    </div>
</body>
